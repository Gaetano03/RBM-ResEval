...
void Write_History_ResError(prob_settings settings, std::string method, int it1, int it2){
    ...
    if (history_su2.is_open() && error_su2.is_open()){
        std::string linedata1, linedata2, token;
    ...
    if ( it2 == 0 ){
        ...
        if ( history_global.is_open() && error_global.is_open() ) {
